...
PLANTED ISSUE: The Lambda timeout is set to 3 seconds in template.yaml,
but the DynamoDB scan operation can take 4-5 seconds for large tables,
...
def get_all_products():
    ...
    PLANTED ISSUE: Uses scan() which is slow for large tables.
    Combined with the 3s timeout, this will cause timeout errors.
    """
